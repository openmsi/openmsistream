...
class OpenMSIStreamArgumentParser(ArgumentParser):
    ...
    ARGUMENTS = {
        "filepath": [
            "positional",
            {"type": existing_file, "help": "Path to the data file to use"},
        ],
        "output_dir": [
            "positional",
        ...
        "update_seconds": [
            "optional",
            {
                "default": RUN_CONST.DEFAULT_UPDATE_SECONDS,
                "type": int,
                "help": (
    ...
    def add_arguments(self, *args, **kwargs):
        ...
        :raises ValueError: if the name of an argument isn't recognized in
            :attr:`~OpenMSIStreamArgumentParser.ARGUMENTS`, or if the type of a new
