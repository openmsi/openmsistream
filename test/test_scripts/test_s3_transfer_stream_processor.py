...
def validate_s3_transfer(watched_dir, topic, logger):
    """
    ...
    for fp in watched_dir.rglob("*"):
        ...
        object_key = f"{topic}/{fp.relative_to(watched_dir)}"
...
def test_s3_transfer_stream_processor(
    ...
    topic = "test_s3_transfer_stream_processor"
    ...
    #
    validate_s3_transfer(watched_dir, topic, logger)
