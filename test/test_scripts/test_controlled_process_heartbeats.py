...
from openmsistream.utilities.controlled_processes_heartbeats import (
...
class ControlledProcessSingleThreadForTesting(ControlledProcessSingleThreadHeartbeats):
...
class ControlledProcessMultiThreadedForTesting(ControlledProcessMultiThreadedHeartbeats):
